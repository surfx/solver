...
namespace classes.regras.binarias
{
    ...
    */
    public class RegraFalseE2 : IRegraBinaria
    {
        public string RULE { get => "F ˄2"; }
        ...
        public bool isValid(ConjuntoFormula cf1, ConjuntoFormula cf2)
        {
            ...
            if (ac1 == null || ac1.isAtomo || ac1.ConectorProp == null || ac1.ConectorProp.Simbolo != ESimbolo.E || ac1.ConectorProp.Direita == null) { return false; }
